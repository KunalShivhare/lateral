    ...
    <div className="flex w-full flex-col-reverse items-center justify-between gap-4 overflow-auto p-1 sm:flex-row sm:gap-8">
      ...
      <div className="flex flex-col-reverse items-center gap-4 sm:flex-row sm:gap-6 lg:gap-8">
        <div className="flex items-center space-x-2">
          <p className="whitespace-nowrap font-medium text-sm text-[var(--primary-text)]">
            Rows per page
          </p>
          <Select
          ...
          >
            <SelectTrigger className="h-8 w-[4.5rem] text-[var(--primary-text)]">
        ...
        <div className="flex items-center justify-center space-x-2">
          <span className="font-medium text-sm text-[var(--primary-text)]">
            Page
          </span>
          <div className="flex items-center space-x-1">
            <Input
              ...
              className="h-8 w-12 text-center text-[var(--primary-text)]"
            />
            <span className="font-medium text-sm text-[var(--primary-text)]">
        ...
        <div className="flex items-center space-x-2">
          <Button
            ...
            variant="outline"
            className="hidden size-8 p-0 lg:flex text-[var(--primary-text)]"
            onClick={() => {
          ...
          <Button
            ...
            variant="outline"
            size="icon"
            className="size-8 text-[var(--primary-text)]"
            onClick={() => {
              table.previousPage();
              if (table.options.onPaginationChange) {
                table.options.onPaginationChange({
          ...
          <Button
            ...
            variant="outline"
            size="icon"
            className="hidden size-8 lg:flex text-[var(--primary-text)]"
            onClick={() => {
