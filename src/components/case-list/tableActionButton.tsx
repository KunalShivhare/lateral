      ...
      {hasSelectedRows && (
        <div>
          <button className="p-2 hover:bg-slate-800 rounded">
            ...
            >
              <circle cx="12" cy="8" r="4" fill="#BABABA" />
              <path
          ...
          <button className="p-2 hover:bg-slate-800 rounded">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d="M12 18L18 12L12 6" stroke="#BABABA" stroke-width="2" />
              <path d="M6 18L12 12L6 6" stroke="#BABABA" stroke-width="2" />
            </svg>
          </button>
          <button className="p-2 hover:bg-slate-800 rounded">
            <svg
          ...
          <button className="p-2 hover:bg-slate-800 rounded">
            ...
            >
              ...
              <path
                ...
                stroke-linecap="round"
              />
              <circle cx="12" cy="8" r="5" fill="#BABABA" />
            </svg>
          </button>
          <button className="p-2 hover:bg-slate-800 rounded">
            <svg
      ...
      <div className="flex items-center ml-auto gap-2">
        <button className="p-2 hover:bg-slate-800 rounded">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <path d="M15 6L9 12L15 18" stroke="#BABABA" stroke-width="2" />
          </svg>
        </button>
        <button className="p-2 hover:bg-slate-800 rounded">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <path d="M9 6L15 12L9 18" stroke="#BABABA" stroke-width="2" />
          </svg>
        </button>
        <button className="p-2 hover:bg-slate-800 rounded">
          <svg
