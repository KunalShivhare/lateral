...
interface UseDataTableProps<TData>
  ...
  /**
   * Enable client-side filtering instead of server-side filtering.
   * When true, filtering is performed on the client side.
   * @default false
   * @type boolean
   */
  ...
  /**
   * Custom filter functions for client-side filtering.
   * @type Record<string, FilterFn<TData>>
   */
...
export function useDataTable<TData>({
  ...
  const table = useReactTable({
    ...
    getFacetedUniqueValues: enableAdvancedFilter
      ? undefined
      : getFacetedUniqueValues(),
    manualPagination: !clientSideFiltering,
    manualSorting: !clientSideFiltering,
    manualFiltering: !clientSideFiltering || enableAdvancedFilter,
    filterFns,
  });
